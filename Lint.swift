...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-sequence-primitives open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-sequence-primitives project authors
...
// Shape-γ unified consumer manifest. swift-sequence-primitives does NOT
